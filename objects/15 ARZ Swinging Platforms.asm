...
; loc_FCCA:
Obj15_Init:
	addq.b	#2,routine(a0)				; initialize to normal swinging platform routine
...
+
	...
	addq.b	#4,routine(a0)
+
	move.b	d1,d4			; copy subtype to d4
	andi.b	#$70,d4			; isolate upper bit in d4
	andi.w	#$F,d1			; d1 = number of links
	move.w	x_pos(a0),d2
	move.w	y_pos(a0),d3
